...
(** Seal a variant. Each case's selector runs at most once per projection.
    [@@deriving observe] generates the selectors; manual descriptions supply
    [~is] or [~project] explicitly. *)
